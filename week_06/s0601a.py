...
'''
строки 7, 8, 14 можно убрать. смысл не поменяется.

7, 8 - len(a) можно и со скобками оставить, так даже читабельнее

14 не нужна т, к. a и b уже и так поменялись местами.
